...
/* harmony import */ var _services_modal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../services/modal */ "./js/services/modal.js");
...
function addTask() {
  ...
  function _postData() {
    _postData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url, data) {
      var res;
  ...
  modalAddOpen.addEventListener('click', function () {
    (0,_services_modal__WEBPACK_IMPORTED_MODULE_10__.modalOpen)(modalAdd);
  });
  document.addEventListener('keydown', function (event) {
    if (event.code === 'Escape' && modalAdd.classList.contains('modal_show')) {
      (0,_services_modal__WEBPACK_IMPORTED_MODULE_10__.modalClose)(modalAdd);
    }
  });
  ...
  modalAdd.addEventListener('submit', function (event) {
    ...
    var form = modalAdd.querySelector('form'); //конструкция данных из форм

    var formData = new FormData(form); //Превращение данных в матрицу, потом в объект.

    var json = Object.fromEntries(formData.entries()); //обработка строк для человеческого вида, если пользователь страдает от психических расстройств и вводит не пойми что

    json.name = S("".concat(json.name)).replaceAll('_', '').s;
    json.description = S("".concat(json.description)).replaceAll('_', '').s;
    json.name = S("".concat(json.name)).humanize().s;
    json.description = S("".concat(json.description)).humanize().s; //превращение данных в json

    json = JSON.stringify(json);
    console.log(json); //обработка промиса

    postData('http://localhost:8080/api/create-task', json).then(function (res) {
      if (res.status === 200) {
        alert('Успешно отправлено!');
      } else {
        alert("\u041E\u0442\u043F\u0440\u0430\u0432\u043A\u0430 \u0434\u0430\u043D\u043D\u044B\u0445 \u043D\u0435 \u043F\u0440\u043E\u0438\u0437\u043E\u0448\u043B\u0430, \u043A\u043E\u0434 \u043E\u0448\u0438\u0431\u043A\u0438 ".concat(res.status));
      }
...
function modalLogin() {
  ...
  modalLoginOpen.addEventListener('click', function () {
...
function renderTasks() {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 5:
              ...
              throw new Error("\u041D\u0435 \u043F\u043E\u043B\u0443\u0447\u0430\u0435\u0442\u0441\u044F \u043E\u0431\u0440\u0430\u0431\u043E\u0442\u0430\u0442\u044C fetch ".concat(url, ", \u0441\u0442\u0430\u0442\u0443\u0441: ").concat(res.status));
  ...
  var arrayTasks = [];
  getData('http://localhost:8080/api/tasks').then(function (res) {
    arrayTasks = res;
...
function taskVisibleDescr() {
  var tasksTitle = document.querySelectorAll('.main__task-title');
  var tasksDescr = document.querySelectorAll('.main__task-block-two');
  tasksDescr.forEach(function (item) {
    item.style.display = 'none';
  });
  tasksTitle.forEach(function (item) {
    item.addEventListener('click', function () {
      var itemDescr = tasksDescr[item.dataset.task - 1];
      var triangle = item.querySelector('svg');
...
/* harmony import */ var _modules_taskVisibleDescr__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/taskVisibleDescr */ "./js/modules/taskVisibleDescr.js");
/* harmony import */ var _modules_addTask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/addTask */ "./js/modules/addTask.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_addTask__WEBPACK_IMPORTED_MODULE_4__.default)();
  (0,_modules_taskVisibleDescr__WEBPACK_IMPORTED_MODULE_3__.default)();
});
})();
